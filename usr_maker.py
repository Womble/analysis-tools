...
R=int(sys.argv[1]) #R_* in tenths of a solar radii

fn,r,k,a={41:('04p1',4.1,0.5825,0.534), 44:('04p4',4.46,0.588,0.537), 55:('05p5',5.5,0.32,0.565), 77:('07p7',7.7,0.617,0523), 117:('11p7',11.7,0.86,0.519), 162:('16p2',16.2,0.79,0.523)}[R]
...
#include "starwind_{0}.h"
#include "innerDisc.h"

#include <map>
#include <string>

#include "disc_1e-4_{0}.h"
#include "largeDisc_{0}.h"

#define M_acc     (1e-4*m_sol/(3600*24*365.25))  
#define M_star    (10*m_sol)
#define r_star    ({1}*r_sol)
...
#define rho0 (1e-5*pow(r_star*5.5/{1},3))
#define rho_amb (1e13)
...
with open('temp.c','w') as f:
    f.write(usrStr.format(fn,r,k,a))
